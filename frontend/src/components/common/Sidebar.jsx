const Sidebar = ({toggleSidebar}) => {
    return (
        <div className={`hs-overlay [--body-scroll:true] lg:[--overlay-backdrop:false] [--is-layout-affect:true] [--auto-close:lg] ${toggleSidebar ? 'translate-x-0 ' : '-translate-x-full'} transition-all duration-300 transform w-64 h-full flex fixed inset-y-0 start-0 z-60 bg-white border-e border-gray-200`} role="dialog" aria-label="Sidebar">
            <div className="relative flex flex-col h-full max-h-full w-full">
                <div className="px-3 py-2 flex items-center w-full border-b border-gray-200">

                    <a className="w-full flex-none rounded-xl text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="#" aria-label="Preline">
                        <img src="/circle-logo.jpg" alt="" className="w-[81px]" />
                    </a>
